...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/jupyterview-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15651&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/jupyterview-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `jupyterview` can be installed with:

```
conda install jupyterview
```

It is possible to list all of the versions of `jupyterview` available on your platform with:
